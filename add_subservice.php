                                              ...
                                              <form class="form-horizontal" role="form" method="post" enctype= "multipart/form-data">
                                                <div class="form-group">
                                                   ...
                                                   <select class="form-control" name="service_id" required>
                                                    <option value=""<?php if($cat_id=='') echo 'selected';?>>Select Service</option>
                                                    <?php 
                                                    ...
                                                    <option value="<?php echo $k['s_id'];?>" <?php if($k['s_id']==trim($cat_id)){ echo  'selected'; }?>><?php echo $k['s_id'];?></option>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-lg-6">
                                                      <input type="text" name="s_head" value=""  class="form-control" required>
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
                                                      <label class="col-lg-2 control-label">Description</label>
                                                      <div class="col-lg-6">
                                                          <textarea  id="" class="form-control" cols="30" rows="5"placeholder="Product Description" name="s_description" required></textarea>
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
