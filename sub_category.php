...
$q1="insert into subcategory(sub_catName,cat_id,pro_date) values ('$sub_catName','$cat_id',CURDATE()) ";
ExecuteQuery($q1); 
}
?> 
<html lang="en">
								...
								<option value="<?php echo $cat_id;?>" <?php if($cat_id==$k['cat_id']){ echo  'selected'; }?>><?php echo $cat_name ?></option>
								  ...
								  <?php }?>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-lg-6">
                                                          <input type="text" class="form-control" id="url" placeholder="Sub Category " name="sub_catName"  required>
                                                      </div>
                                                  </div>
