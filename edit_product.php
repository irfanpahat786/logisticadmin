...
$cat_id= $_POST['cat_id'];
$sub_id=$_POST['sub_id']; 
$q2="select cat_name from category where cat_id='$cat_id' ";
ExecuteQuery($q2); 
//$cat_name1=$q2['cat_name'];

$pname=$_POST['pname'];
$pprice=$_POST['pprice'];
$pqty=$_POST['pqty'];
$pdesc=addslashes($_POST['pdisc']);
$stock=$_POST['stock'];
$pdescr=addslashes($_POST['pdescr']); 
$q1="update product set cat_id='$cat_id',sub_id='$sub_id', pro_name='$pname', pro_description='$pdescr',pro_qty='$pqty',pro_price='$pprice',pro_disc='$pdesc',pro_stock='$stock' where pro_id='$id'";
ExecuteQuery($q1); 
}
if(isset($_POST['op']))
{
                    ...
                    <section class="panel">
                          <div class="panel-body">
                              <div class="tab-content"> 
								...
								<option value=""<?php if($sub_id=='') echo 'selected';?>>Select Cetegory</option>
								<?php 
									...
									$ar=ExecuteQueryResule($q);
									 ...
									 { 
									 	$sub_id=$ak['sub_id'];
										$sub_catName=$ak['sub_catName'];
								    ?>
							
								<option value="<?php echo $sub_id;?>" <?php if($sub_id==$k['sub_id']){ echo  'selected'; }?>><?php echo $sub_catName?></option>
								  ...
								  <?php }?>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <div class="col-lg-6">
                                                          <input type="text" class="form-control" id="mobile" placeholder="Product Stock " name="stock" value="<?php echo $k['pro_stock'] ?>">
                                                      </div>
                                                  </div>
                                                  <div class="form-group">
